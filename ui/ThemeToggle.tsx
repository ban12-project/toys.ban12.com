...
import { useStore, type SettingState } from '@/lib/store'
...
function useTheme(): [SettingState['setting'], SettingState['setSetting']] {
  const [setting, setSetting] = useStore((state) => [
    state.setting,
    state.setSetting,
  ])
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="dark:highlight-white/5 relative flex items-center rounded-lg p-2 font-semibold text-slate-700 shadow-sm ring-1 ring-slate-900/10 dark:bg-slate-600 dark:text-slate-200 dark:ring-0">
        ...
        <select
          ...
          value={setting!}
          onChange={(e) =>
            setSetting(e.target.value as SettingState['setting'])
          }
